      ...
      >
        <div className="flex items-center ml-6">
          ...
          <div className="ml-auto">
            <SocialIcon
              url="https://github.com/sourishdasss/invst_"
              fgColor="gray"
              bgColor="transparent"
            />
          </div>
        ...
        <div className="px-0 md:px-10 text-center">
          ...
          <p className="mt-2 mb-2 text-gray-300">
            INV$T is a service allows the user to preview real-time price
            changes in their created portfolio and sends users an email
            notification if a specific stock in the portfolio reaches a certain
