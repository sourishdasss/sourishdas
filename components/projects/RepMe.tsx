      ...
      >
        <div className="flex items-center ml-6">
          ...
          <div className="ml-auto">
            <SocialIcon
              url="https://github.com/sourishdasss/repme"
              fgColor="gray"
              bgColor="transparent"
            />
          </div>
        ...
        <div className="px-0 md:px-10 text-center">
          ...
          <p className="mt-2 mb-2 text-gray-300">
            RepMe is an innovative web app solution that to everyday free weight
            exercises, by keeping track of the number of reps the user is
            performing and logging that number into their history.
          </p>
          ...
          <div className="flex font-light text-center">
            <p className="font-div text-sm mt-4 mb-6 font-thin text-[#3792c0]">
              Python, Flask, Pandas, OpenCV, MediaPipe, Matplotlib, Numpy, React
            </p>
          </div>
        </div>
      </article>
