      ...
      >
        <div className="flex items-center ml-6">
          ...
          <div className="ml-auto">
            <SocialIcon
              url="https://github.com/sourishdasss/netflix2.0"
              fgColor="gray"
              bgColor="transparent"
            />
          </div>
        ...
        <div className="px-0 md:px-10 text-center">
          ...
          <p className="mt-2 mb-2 text-gray-300">
            Netflix2.0 is a web app that replicates the look and feel of
            Netflix, by allowing users to log into their persnalized accounts,
            and browsing through popular content.
          </p>
          ...
          <div className="flex font-light text-center">
            <p className="font-div text-sm mt-4 mb-6 font-thin text-[#3792c0]">
              React, Firebase DB, Stripe Checkouts, TMDB API
            </p>
          </div>
        </div>
      </article>
