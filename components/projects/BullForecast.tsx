      ...
      >
        <div className="flex items-center ml-6">
          ...
          <div className="ml-auto">
            <SocialIcon
              url="https://github.com/sourishdasss/bull-forecast"
              fgColor="gray"
              bgColor="transparent"
            />
          </div>
        ...
        <div className="px-0 md:px-10 text-center">
          ...
          <p className="mt-2 mb-2 text-gray-300">
            Bull Forecast is a web app that uses Additive Regression to provide
            real-time price updates and predictions about all publicly traded
            stocks in the NYSE and NASDAQ and over 50 cryptocurrencies in a
          ...
          <div className="flex font-light text-center">
            <p className="font-div text-sm mt-4 mb-6 font-thin text-[#3792c0]">
              Python, Streamlit, Pandas, Matplotlib, Yahoo Finance
            </p>
          </div>
        </div>
      </article>
